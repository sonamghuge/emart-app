        ...
        return (
            <div className="col-sm-4 mb-4">
                    ...
                    <div className="text-center">
                      ...
                      <hr/> 
                      <h4 className="card-title">{fashion.prodName}</h4>
                      <p className="card-text">{fashion.brand}</p>
                      <p className="card-text">{fashion.prodDescription}</p>

                      <p className="card-text">Model no: {fashion.model_no}</p>
               
                      <h5 className="card-text">Product Price:<small>${fashion.prodPrice}</small></h5>
